...
function addUpgrades(app: Application) {
  ...
  upgradeList.push(
    ...
    new Upgrade(backStations[0], BigNumber.from(2000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(3000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(4000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(8000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(12000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(16000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(20000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(80000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(100000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(120000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(140000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(560000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(700000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(840000), 2, "price-multiplier"),
    new Upgrade(backStations[0], BigNumber.from(980000), 2, "price-multiplier"),
  );
