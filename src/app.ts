...
function addUpgrades(app: Application) {
  ...
  upgradeList.push(
    new Upgrade(new CustomerWorker(0, 0), BigNumber.from(190), 1, "customer"),
    new Upgrade(new BackWorker(0, 0), BigNumber.from(850), 2, "worker-back"),
    new Upgrade(
      new CustomerWorker(0, 0),
    ...
    new Upgrade(new CustomerWorker(0, 0), new BigNumber(142, 3), 1, "customer"),
    new Upgrade(new BackWorker(0, 0), new BigNumber(170, 3), 1, "worker-back"),
